...
if __name__ == "__main__":
    ...
    models_dir= f"models/PPO-speeds-45-{int(time.time())}"
    logdir= f"logs/PPO-speeds-45-{int(time.time())}"
    ...
    model=PPO('MlpPolicy', env, verbose=1, tensorboard_log=logdir, ent_coef=0.001)
    TIMESTEPS= 3000000
