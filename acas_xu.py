...
class AcasEnv(gym.Env):
    metadata = {"render_modes": ["human", "rgb_array"], "render_fps": 60}  # Ralentir l'animation à 15 FPS
    ...
    def __init__(self, 
        ...
        self.screen = None
        self.clock = None
        self.window_size = (LENGTH, WIDTH)  # Agrandir la fenêtre PyGame
    ...
    def draw_time(self):
        """Affiche le temps écoulé en haut à gauche de l'écran."""
    ...
    def render(self, render_mode="human"):
        ...
        scale = 0.02  # Ajustement de l'échelle pour mieux adapter la fenêtre
    ...
    def draw_dashed_line(self, surface, color, start_pos, end_pos, dash_length=10, width=2):
        """Dessine une ligne pointillée entre start_pos et end_pos."""
        x1, y1 = start_pos
        x2, y2 = end_pos
        dx, dy = x2 - x1, y2 - y1
        ...
        for i in range(dash_num):
            if i % 2 == 0:  # Dessiner seulement un segment sur deux
